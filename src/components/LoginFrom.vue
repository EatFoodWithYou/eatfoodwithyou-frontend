  ...
  <div class="my-80">
    ...
    <div>
      <form class="my-10" @submit.prevent="login">
        ...
        <div class="flex text-2xl justify-center items-center text-black my-6">
          <input
            class="py-2 px-4 rounded-lg w-1/5 min-w-max focus:outline-none focus:ring focus:border-backgroundButton"
            type="password"
        ...
        <div class="flex text-2xl justify-center items-center">
          <button
            class="text-white my-3 bg-backgroundButton  p-1 pb-2 px-8 content-center rounded-full hover:bg-gray-500 transition duration-50 ease-in-out"
          >
            Login
          </button>
        </div>
